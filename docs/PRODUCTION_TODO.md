...
- [ ] Enable authenticated SMTP for the Microsoft 365 mailbox and securely store `SMTP_USER` and `SMTP_PASSWORD`.
- [ ] Use a dedicated authorized sender configured through `SMTP_FROM_EMAIL` and `SMTP_FROM_NAME`.
