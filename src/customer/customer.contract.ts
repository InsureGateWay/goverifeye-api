...
export type ShopperDto = { id: string; email: string; displayName?: string };
...
export type ShopperRegistrationVerifyRequestDto = { challengeId: string; code: string };
export type ShopperRegistrationVerifiedDto = { registrationToken: string; expiresInSeconds: number };
export type ShopperRegistrationCompleteRequestDto = { registrationToken: string; displayName: string; password: string };
export type ShopperPasswordLoginRequestDto = { email: string; password: string };
export type ShopperPasswordResetVerifyRequestDto = { challengeId: string; code: string };
export type ShopperPasswordResetVerifiedDto = { resetToken: string; expiresInSeconds: number };
export type ShopperPasswordResetCompleteRequestDto = { resetToken: string; password: string };
