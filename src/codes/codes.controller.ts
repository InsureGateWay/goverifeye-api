...
export class CodesController {
  ...
  @Post(':id/suspend') suspendBatch(@CurrentUser()user:RequestContext,@Param('id')id:string){return this.codes.suspendBatch(user.organizationId,user.userId,id)}
  @Post(':id/reactivate') reactivateBatch(@CurrentUser()user:RequestContext,@Param('id')id:string){return this.codes.reactivateBatch(user.organizationId,user.userId,id)}
