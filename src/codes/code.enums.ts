...
export enum BatchStatus { Generating='generating', Generated='generated', Allocated='allocated', ReleasedForActivation='released_for_activation', MarketActive='market_active', Recalled='recalled', Revoked='revoked', Retired='retired', Failed='failed' }
