...
/**
 * Restore the one-time organization transfer used when an approved vendor
 * claims platform-owned Open Market inventory. All other batch identity and
 * vendor changes remain immutable.
 */
export class RestoreOpenMarketCodeFlow1726700000000 implements MigrationInterface {
  name = 'RestoreOpenMarketCodeFlow1726700000000';
