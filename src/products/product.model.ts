export enum ProductStatus { Active='active', Pending='pending', InformationRequired='information_required', Rejected='rejected', Recalled='recalled', Archived='archived' }
...
export interface Product {
  ...
  status: ProductStatus; statusBeforeArchive?:ProductStatus|null; rejectionReason?: string; informationRequest?:string|null; infoRequiredFields?:string[]; totalCodes: number; scanned: number;
