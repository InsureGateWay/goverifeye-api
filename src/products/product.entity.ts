...
export class ProductEntity extends BaseEntity {
  ...
  @Column('text', { nullable: true }) rejectionReason?: string;
  @Column('text', { nullable: true }) informationRequest?: string | null;
  @Column({ type: 'jsonb', default: () => "'[]'::jsonb" }) infoRequiredFields!: string[];
  @Column({ default: 0 }) totalCodes!: number;
